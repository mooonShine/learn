...
var bdShare=bdShare||{version:"1.0"};
    ...
    bdShare.ready=bdShare.ready||function(B,C){C=C||document;

            if(/complete/.test(C.readyState)){B()}else{
...
bdShare.loadScript=bdShare.loadScript||function(B){
        ...
        A.src=B;bdShare.ready(
            function(){
                document.getElementsByTagName("script")[0].parentNode.appendChild(A)})};
if(bdShare.fn&&bdShare.fn.init){
    bdShare.fn.init()}else{
    bdShare.velocity={start:+new Date};
